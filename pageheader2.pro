...
UBUNTU_TRANSLATION_DOMAIN="pageheader2.liu-xiao-guo"
...
aptest.commands = bash $$PWD/pageheader2/tests/autopilot/run
aptest.depends  = sub-pageheader2

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/pageheader2/tests/unit
unittest.depends  = sub-pageheader2
